...
//    Page<Book> findAllWithoutContent(Pageable pageable); // возвращает список книг (с постраничностью)
    ...
    // обновить статистику просмотров для книг
    @Modifying
    ...
    void updateRating(@Param("totalRating") long totalRating, @Param("totalVoteCount") long voteCount, @Param("avgRating") int avgRating, @Param("id") long id);
